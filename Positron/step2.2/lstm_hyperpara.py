...
# Kept for reference before the L1 diagnostic scan:
# param_grid = {
#         "epoch_begin":           [0],
#         "epochs":                [5000],
#         "learning_rate":         [0.0001],
...
#         }
#
# L1 diagnostic scan: keep the other regularization choices fixed and only
# vary a small L1 range first.
param_grid = {
        "epoch_begin":           [0],
        "epochs":                [5000],
        "learning_rate":         [0.0001],
        "neurons":               [32],
        "l1":                    [0, 0.000001, 0.000003, 0.00001],
        "l2":                    [0.005],
        "dropout":               [0.20],
        "batch_size":            [64],
        "look_back":             [365],
